...
| `shift_l` | Input | 1 | Shift left control |
| `shift_r` | Input | 1 | Shift right control |
...
3. **Shift Left**: When enable=1 and shift_l=1, shift data left (circular)
4. **Shift Right**: When enable=1 and shift_r=1, shift data right (circular)
